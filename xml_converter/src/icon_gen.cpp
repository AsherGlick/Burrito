...
bool Icon::init_xml_attribute(rapidxml::xml_attribute<>* attribute, vector<XMLError*> *errors) {
    ...
    if (attributename == "minsize") {
        ...
        this->distance_fade_end_is_true = true;
    }
        ...
        this->render_on_map_is_true = true;
    }
